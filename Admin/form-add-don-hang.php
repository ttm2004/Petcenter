...
if (isset($_POST['save_order'])) {
  ...
  foreach ($_POST['pet_name'] as $index => $pet_name) {
    ...
    $sql_pet = "INSERT INTO ThuCung (TenThuCung, MaKH, TinhTrang, MauSac, CanNang, HinhAnh, NgayTiepNhan, GhiChu, MaDonChamSoc, MaLoaiThuCung, MaDichVu) 
                    VALUES (?, ?, ?, ?, ?, ?, NOW(), ?, ?, ?, ?)";
...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href=".php"><i class='app-menu__icon fa-solid fa-user'></i> <span
