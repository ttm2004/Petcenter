    ...
    <main class="app-content bg-gray-100">
        ...
        <div class="container mx-auto p-8">
            ...
            <div class="flex flex-wrap gap-4 mb-6">
                ...
                <button class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded" onclick="myFunction(this)">Tải từ file</button>
                <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Tạo mới khách hàng</button>
            </div>
