                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            ...
                            <div class="col-sm-2">
                                <a class="btn btn-danger btn-sm" href="form-add-customer.php" title="Thêm"><i class="fas fa-plus"></i> Tạo mới nhân viên</a>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div id="deleteConfirmationModal" class="modal" style="display: none;">
                            <div class="modal-content" style="padding: 15px;width: 34%;">
                                ...
                                <p>Bạn có chắc chắn muốn xóa những nhân viên đã chọn?</p>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <input type="text" id="searchInput" class="form-control" placeholder="Tìm kiếm " onkeyup="searchTable()">
                            </div>
                        </div>
                        <br>
                        ...
                        <form id="customerForm">
                            <table class="table table-hover table-bordered js-copytextarea" id="sampleTable">
                                ...
                                <tbody id="customerTableBody">
                                    ...
                                    $query = "SELECT * FROM NhanVien WHERE VaiTro != 'QuanLy'
                                LIMIT $offset, $records_per_page"; // Thêm LIMIT để phân trang
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        <td>" . $row["VaiTro"] . "</td>
                                        <td>
                                            <a href='details-employee.php?MaNV=" . $row["MaNV"] . "' class='btn btn-warning btn-sm'><span style='font-family: 'Times New Roman', Times, serif;' ><i class='fa-solid fa-layer-group'></i>Chi tiết</span></a>
                                        </td>
                                      </tr>";
                                        }
                                    } else {
                                    ...
                                    $count_query = "SELECT COUNT(*) as total FROM NhanVien WHERE VaiTro != 'QuanLy'" ;
