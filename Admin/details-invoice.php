        ...
        WHERE 
            DonChamSoc.MaDonChamSoc = ?";
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <p><strong>Người chăm sóc:</strong> <?php echo $row['HoTenNV'] ?? 'Không có nhân viên nào được phân công'; ?></p>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <!-- <a href="edit-data-oder.php?MaDonChamSoc=<?php echo $maDonChamSoc; ?>" class="btn btn-warning">Sửa thông tin</a> -->
                        <a href="delete-data-oder.php?MaDonChamSoc=<?php echo $maDonChamSoc; ?>" class="btn btn-danger">Xóa đơn</a>
                        <?php
                        ...
                        <a href="phancong.php?MaDonChamSoc=<?php echo $maDonChamSoc; ?>" class="btn btn-info">Phân công nhân viên</a>
                    </div>
