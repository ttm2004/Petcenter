...
if (isset($_SESSION['user'])) {
  $displayName = htmlspecialchars($_SESSION['role']); // Lấy tên người  dùng
} else {
  $displayName = 'Login'; // Nếu chưa đăng nhập
}
...
<body>
    <div class="header">
        <div class="head">
            <div class="info adr">
                <i class="fa-solid fa-house-chimney "
                    style="--fa-primary-color: dodgerblue; --fa-secondary-color: gold; --fa-secondary-opacity: 1.0;"></i>
        ...
        <nav class="menu">
            ...
            <ul id="main-menu">
                <li class="list"><a href="index.php">Trang Chủ</a></li>
        ...
        <div class="slides">
            <div class="slide slide1">
                <div class="slide-content">
                    ...
                    <button id="btn-slide1-cnt"><a href="../book/book.php" value="d"
                            style="list-style:none;width:100%;height:100%;text-decoration: none;display: block;">Đặt
                            cuộc hẹn</a></button>
                </div>
            ...
            <div class="slide slide2">
                <div class="slide-content">
                    ...
                    <button id="btn-slide2-cnt"><a href="../book/book.php"
                            style="list-style:none;width:100%;height:100%;text-decoration: none;display: block;">Đặt
                            cuộc hẹn</a></button>
                </div>
                <div class="img-animal">
            ...
            <div class="slide slide3">
                <div class="slide-content">
                    ...
                    <button id="btn-slide3-cnt"><a href="../book/book.php"
                            style="list-style:none;width:100%;height:100%;text-decoration: none;display: block;">Đặt
                            cuộc hẹn</a></button>
                </div>
                <div class="img-animal">
        ...
        <div class="information-ct">
            ...
            <div class="support">
                ...
                <ul class="main-adr">
                    ...
                    <li class="sp-list">
                        <a href="/index.php">Chăm sóc khách khàng</a>
                    </li>
                    <li class="sp-list">
                        <a href="/index.php">Vận chuyển và đổi trả hàng</a>
                    </li>
                    <li class="sp-list">
