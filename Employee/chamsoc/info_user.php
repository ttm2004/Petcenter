...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="info_user"><i class='app-menu__icon bx bx-id-card'></i> <span
...
-->
  ...
  <script src="js/hours.js">
    

    //Modal
    $(document).ready(function() {
      $("#show-emp").on("click", function() {
        // Open the modal with backdrop and keyboard disabled
        $("#ModalUP").modal({
          backdrop: 'static',
          keyboard: false
        });
