...
<head>
  <title>Trang dành cho nhân viên</title>
  <meta charset="utf-8">
...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <hr>
    <ul class="app-menu">
      <li><a class="app-menu__item active" href="dasbroad.php"><i class='app-menu__icon bx bx-tachometer'></i><span
  ...
  <script type="text/javascript" src="js/hours.js">
    ...
    // Hàm để kiểm tra số lượng sản phẩm hết hoặc sắp hết
    function updateOutOfStockCount() {
      let count = 0;

      products.forEach(product => {
        // Kiểm tra sản phẩm sắp hết hoặc hết hàng
        if (product.soluong <= 2) { // Giả sử sản phẩm có số lượng <= 2 thì coi là sắp hết
          count++;
        }
      });

      // Cập nhật số lượng sản phẩm vào giao diện
      document.getElementById("outOfStockCount").innerText = count + " sản phẩm";
    }
